...
public class RateBottomSheet extends DialogFragment {
    ...
    @NonNull @Override public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        TextView title = new TextView(requireContext()); title.setText(AndroidI18n.t("Select rating (0 clears)")); root.addView(title);
        ...
        root.addView(row);
        b.setView(root);
        b.setTitle(AndroidI18n.t("Rate"));
        b.setPositiveButton(AndroidI18n.t("Save"), (d,w)->{
            ...
            new Thread(() -> {
                ...
                } catch (Exception e) { requireActivity().runOnUiThread(()-> Toast.makeText(requireContext(), AndroidI18n.t("Rating failed"), Toast.LENGTH_LONG).show()); }
            }).start();
        });
        b.setNegativeButton(AndroidI18n.t("Cancel"), null);
        return b.create();
    }
}
