...
impl KafkaNotifier {
    ...
    pub fn new(
        ...
        _requred_acks: Option<String>,
        _compression: Option<String>,
        _idle_timeout: Option<u64>,
        _send_timeout: Option<u64>,
        _extra_opts: Option<ExtraKafkaOptions>,
    ) -> RustusResult<Self> {
        Err(RustusError::Unimplemented(String::from(
            "Kafka notifier support is disabled in this build.",
        )))
    }
}
