...
impl MetaStore for PgMetaStore {
    ...
    async fn upsert_photo(
        ...
        let sql = "INSERT INTO photos (
	                ...
	                duration_ms, delete_time, is_screenshot, camera_make, camera_model, iso, aperture, shutter_speed,
	                ...
	                $16::bigint, 0, $17::integer, $18, $19, $20::integer, $21::double precision, $22,
	                $23::double precision, $24::double precision, $25::double precision, $26::double precision, $27, $28, $29, $30, $31, $32,
	                $33, $34::bigint
